...
public class Camera2BasicFragment extends Fragment
    ...
    private static final int SHOW_ZOOM = 0;
...
//            mSeekBarTextView.startAnimation(mAlphaOutAnimation);
    ...
    private Handler mMainHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == WINDOW_TEXT_DISAPPEAR) {
                if (msg.obj == null) {
                    return;
                }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_flash: {
                ...
                lv2.setOnItemClickListener(new FlashItemClickListener(mPreviewRequestBuilder, mCaptureSession, mBackgroundHandler, window2, mBtnFlash, mCaptureCallback, mWindowTextView));
